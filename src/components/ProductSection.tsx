              ...
              <div className="text-center space-y-5">
                ...
                <div className="flex justify-between items-center pt-6 border-t border-gradient-to-r from-olive/20 via-transparent to-olive/20">
                  ...
                  <div className="flex gap-3">
                    {/* Pulsante carrello ridisegnato */}
                    <button 
                      className="bg-gradient-to-r from-olive to-salvia text-white p-3 rounded-2xl hover:shadow-xl transition-all duration-300 hover:scale-110 flex items-center justify-center cursor-pointer group/btn"
                      onClick={(e) => {
                        e.stopPropagation();
                    ...
                    >
                      <svg className="w-5 h-5 transition-transform group-hover/btn:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                      </svg>
                    </button>
                    
                    {/* Pulsante dettagli ridisegnato */}
                    <Link
                      href={`/products/${product.slug}`}
                      className="bg-gradient-to-r from-nocciola to-nocciola/80 text-white px-6 py-3 rounded-2xl text-sm font-semibold hover:shadow-xl transition-all duration-300 hover:scale-105 text-center group/btn"
                      onClick={(e) => e.stopPropagation()}
                    >
                      <span className="transition-transform group-hover/btn:scale-105 inline-block">
                        Dettagli
                      </span>
                    </Link>
                  </div>
