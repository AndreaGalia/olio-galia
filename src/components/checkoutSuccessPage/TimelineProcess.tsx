        ...
        <div className="space-y-8 sm:space-y-12">
          ...
          <div className="relative flex items-start md:items-center">
            ...
            <div className="hidden md:flex flex-1 pl-8">
              <span className="text-sm bg-olive text-beige px-3 py-1 border border-olive/20">{t.checkoutSuccess.timeline.steps.confirmation.status}</span>
            </div>
          </div>
          ...
          <div className="relative flex items-start md:items-center">
            ...
            <div className="hidden md:flex md:items-center flex-1 justify-end pr-8">
              <span className="text-sm bg-salvia text-beige px-3 py-1 border border-salvia/20">{t.checkoutSuccess.timeline.steps.preparation.status}</span>
            </div>
