  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8 pt-6 border-t border-olive/20">
      <div className="text-center">
        <div className="text-sm font-medium text-black mb-1">{info.email}</div>
        <div className="text-sm text-black">{displayEmail}</div>
      </div>
      <div className="text-center">
        <div className="text-sm font-medium text-black mb-1">{info.phone}</div>
        <div className="text-sm text-black">{displayPhone}</div>
      </div>
      <div className="text-center">
        <div className="text-sm font-medium text-black mb-1">{info.whatsapp}</div>
        <div className="text-sm text-black">{displayWhatsApp}</div>
      </div>
    </div>
  );
}