  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 lg:hidden animate-fadeIn">
      <button
        ...
        className="w-full bg-olive text-beige py-2 sm:py-3 px-4 font-serif termina-11 transition-all duration-300 uppercase tracking-wider hover:bg-sabbia hover:text-olive flex items-center justify-center gap-2 border-t border-olive/20 disabled:opacity-50"
      >
        {checkoutLoading ? (
          <>
