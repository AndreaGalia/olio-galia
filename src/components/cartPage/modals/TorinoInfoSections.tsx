...
export default function TorinoInfoSections() {
  ...
  return (
    <>
      {/* Free shipping info */}
      <div className="bg-white/60 rounded-xl p-4 mb-6 border border-nocciola/20">
        <div className="flex items-start gap-3">
          <div className="w-5 h-5 rounded-full bg-olive/20 flex items-center justify-center flex-shrink-0 mt-0.5">
      ...
      {/* Payment info */}
      <div className="bg-gradient-to-r from-olive/5 to-salvia/5 rounded-xl p-4 mb-6 border border-olive/10">
