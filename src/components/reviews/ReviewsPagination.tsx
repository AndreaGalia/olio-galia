...
export default function ReviewsPagination({
  ...
  return (
    <div className="border-t border-olive/20 mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
      <p className="font-serif termina-11 tracking-[0.15em] uppercase text-black">
      ...
      <div className="flex gap-2 w-full sm:w-auto">
        <button
          ...
          className="flex-1 sm:flex-none px-5 py-2.5 border border-olive/20 font-serif termina-11 tracking-[0.15em] uppercase text-black disabled:opacity-30 disabled:cursor-not-allowed hover:border-olive hover:text-black transition-colors cursor-pointer"
        >
