    ...
    >
      <div className="text-center">
        ...
        <button
          ...
          className="bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-3 sm:px-6 transition-colors duration-300 border border-green-600/20 flex items-center gap-1.5 sm:gap-2 mx-auto uppercase text-xs sm:text-base cursor-pointer"
        >
