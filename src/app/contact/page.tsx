  ...
  const contactMethods = [
    {
      ...
      title: "Email",
      value: "info@oliogalia.it",
      description: "Scrivi per informazioni dettagliate sui nostri prodotti",
    ...
    },
    {
      ...
      title: "WhatsApp",
      value: "+39 366 136 8797",
      description: "Contatto diretto per risposta immediata",
      action: () => window.open('https://wa.me/3661368797?text=Ciao! Vorrei informazioni sui vostri oli extravergini', '_blank')
    }
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-6xl relative z-10">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif text-olive mb-6 leading-tight animate-slide-up">
              Contatta
              <span className="block italic text-salvia">I Tre Fratelli</span>
            </h1>
            
            <p className="text-xl text-nocciola max-w-3xl mx-auto leading-relaxed animate-fade-in-delay">
              Siamo qui per rispondere alle tue domande e aiutarti a scoprire 
              l'olio extravergine perfetto per la tua tavola. Tre generazioni 
              di passione al tuo servizio.
            </p>
          </div>
        </div>
      </section>
