    ...
    try {
      ...
      const response = await fetch(`/api/admin/products/${productId}`, {
        ...
        body: JSON.stringify({
          ...
          displayOrder: (product as any).displayOrder !== undefined ? Number((product as any).displayOrder) : undefined,
          // Waiting List
      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-olive/10 overflow-hidden">
        <div className="p-6 space-y-8">
              ...
              <div className="md:col-span-2">
                ...
                {categoriesLoading ? (
                  ...
                  <div className="flex flex-wrap gap-3">
                    {categories.map(cat => {
                      const selected = (product.categories ?? (product.category ? [product.category] : [])).includes(cat.id);
                      return (
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  id="displayOrder"
                  min={0}
                  value={(product as any).displayOrder ?? ''}
                  onChange={(e) => setProduct(prev => prev ? {
                    ...prev,
          ...
          <section>
            ...
            <ProductStoryEditor
              valueIt={product.translations.it.productStory}
              valueEn={product.translations.en.productStory}
