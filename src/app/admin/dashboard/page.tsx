      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-4 sm:p-6 lg:p-8 shadow-xl border border-olive/10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
          ...
          >
            ...
            <p className="text-nocciola text-xs sm:text-sm">Visualizza e gestisci gli abbonamenti</p>
          </button>
          ...
          >
            ...
            <p className="text-nocciola text-xs sm:text-sm">Invia coupon Stripe ai clienti</p>
          </button>
          ...
          >
            ...
            <p className="text-nocciola text-xs sm:text-sm">
              Configura i template delle email
            </p>
          </button>
          ...
          <button
            onClick={() => router.push('/admin/whatsapp-opt-in')}
            className="p-4 sm:p-5 lg:p-6 border-2 border-green-500/20 rounded-xl hover:border-green-500 hover:bg-green-50 transition-all duration-300 group cursor-pointer text-left"
          >
            <div className="flex items-center mb-3 sm:mb-4">
              <svg
                className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-green-500 group-hover:scale-110 transition-transform"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
                <path
            ...
            <p className="text-nocciola text-xs sm:text-sm">
              Gestisci consensi messaggi WhatsApp
            </p>
          </button>
