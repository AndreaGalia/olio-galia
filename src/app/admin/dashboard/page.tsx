        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-olive/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-olive mb-2 whitespace-nowrap">Gestisci FAQ</h3>
              <p className="text-nocciola text-sm">Crea, modifica e gestisci le domande frequenti</p>
            </button>
