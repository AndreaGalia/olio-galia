        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative z-10">
          <div className="text-center mb-12 sm:mb-16 animate-fade-in">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif text-olive mb-6 leading-tight animate-slide-up">
              I Nostri <span className="italic text-salvia">Prodotti</span>
            </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[
              ...
              {
                icon: "M7 4a3 3 0 016 0v4a3 3 0 11-6 0V4zM4 12a8 8 0 1116 0v-2a6 6 0 10-12 0v2z",
              ...
              >
                <div className={`w-16 h-16 bg-${item.color}/10 rounded-full flex items-center justify-center mx-auto mb-4 hover:bg-${item.color}/20 transition-colors duration-300`}>
                  <svg className={`w-8 h-8 text-${item.color}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
